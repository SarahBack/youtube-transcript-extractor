...
# Example usage for ministry and business
if __name__ == "__main__":
    ...
    video_urls = [
        "https://youtube.com/watch?v=dQw4w9WgXcQ",  # Replace with real URLs
        # Add more URLs here
    ]
    ...
    extractor.save_transcripts(transcripts, format='json', filename='ministry_transcripts')
    extractor.save_transcripts(transcripts, format='txt', filename='ministry_transcripts')
    
    # Prepare for AI training
    ai_preparer = AITrainingDataPreparer()
    training_data = ai_preparer.prepare_for_training(transcripts)
    
    print(f"✅ Extraction complete! {len(training_data)} training segments prepared.")
